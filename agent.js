...
const MANAGER_TOOLS  = new Set(["close_position", "claim_fees", "swap_token", "get_position_pnl", "get_my_positions", "get_wallet_balance", "get_market_mode", "set_market_mode", "deploy_position", "get_active_bin", "get_pool_memory"]);
